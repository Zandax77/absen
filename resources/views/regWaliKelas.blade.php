            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Buat Akun Wali Kelas</h5>
                    <p class="text-center small">Masukkan nama, sandi dan dari kelas</p>
                  </div>

                  <form class="row g-3 needs-validation" action="simpanWali" method="POST">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sudah mempunyai akun? <a href="loginWali">Log in</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                Pendaftaran akun info absen untuk Wali kelas
              </div>
